...
(function (window, document) {
	...
	let mouseDown = hasPointerEvents ? 'pointerdown' : isTouch ? 'touchstart' : 'mousedown';
	let mouseUp = hasPointerEvents ? 'pointerup' : isTouch ? 'touchend' : 'mouseup';
	let mouseMove = hasPointerEvents ? 'pointermove' : isTouch ? 'touchmove' : 'mousemove';
	let mouseLeave = hasPointerEvents ? 'pointerleave' : isTouch ? 'touchleave' : 'mouseleave';
	...
	function fireLongPressEvent (originalEvent) {
		...
		let allowClickEvent = this.dispatchEvent(new CustomEvent('contextmenu', {
			bubbles: true,
			cancelable: true,
			detail: {
	...
	function startLongPressTimer (e) {
		...
		let longPressDelayInMs = parseInt(getNearestAttribute(el, 'data-long-press-delay', '1500'), 10); // default 1500
